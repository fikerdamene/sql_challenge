...
-- 3. Manager, Department Number, Name, employee number, last name, first name
...
-- 6. Employees in 'Sales' employee number, last name, first name
...
-- 7. Employees in 'Sales' & 'Development' department employee number, last name, first name, department name
